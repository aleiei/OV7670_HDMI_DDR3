...
# sys_clk_i is driven internally from top-level MMCM in this project.
# Do not create a primary clock on this scoped MIG input pin.
...
# Not applicable when sys_clk_i is not sourced by a top-level package pin.
...
# Not applicable in this design: sys_clk_i is an internal net into scoped MIG.
